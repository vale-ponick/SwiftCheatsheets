...
## 🎯 Суть
Поменять местами элементы по заданны индексам, не выходя за границы и не изменяя исходный массив.

## 🔥 Почему это важно
- Перемещение строк в таблице
- Перестановка полей в анкете
- Смена порядка колонок в отчёте
